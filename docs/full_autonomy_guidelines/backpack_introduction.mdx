...
- These Backpacks provide Nvidia AGX or Thor to Unitree dogs and humanoids. Each of them comes with one open reference design, speakers, and connectivity to other sensors via Ethernet and USB, with multiple power options. 
