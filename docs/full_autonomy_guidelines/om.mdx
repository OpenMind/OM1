...
set-default-sink alsa_output.{speaker_name}.analog-stereo # Replace speaker_name with your speaker name

# Set default source (microphone)
set-default-source alsa_input.{microphone_name}.mono-fallback # Replace microphone_name with your microphone name
