...
List of actions or capabilities the agent can perform in this mode. Each item in the array is an object with the following properties:

#### **name** *string* — Required

The action identifier name.
...
The connector type that implements this action.
...
Whether to exclude this action from the LLM prompt. Default: false.
