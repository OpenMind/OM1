...
The action connector architecture has been refactored to improve:
...
- Improved performance and hardware alignment  
...
Introduced full support for **OTA updates**, enabling:

- Seamless runtime upgrades  
- Automated deployment of new versions  
- Configuration-based version management  
...
- Best practices for transitions and deployment  

## Breaking Changes & Compatibility Notes

- ML stack behavior differs on AGX due to limited support  
- Configuration files must now include a `version` field  
