...
### [v1.0.2](https://github.com/OpenMind/OM1-system-setup/releases/tag/v1.0.2)

- Introduced the text_embedding container for generating text embeddings for AI provessing.
