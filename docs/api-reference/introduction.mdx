...
| llama-3.1-70b-instruct (Meta Llama)   | $0.10                       | $0.28                        |
| llama-3.3-70b-instruct (Meta Llama)   | $0.10                       | $0.28                        |

<Note>
Near AI models are hosted and served by [Near AI](https://cloud.near.ai).
Meta Llama models are hosted and served by [Openrouter](https://openrouter.ai/).
</Note>
