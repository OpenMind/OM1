...
- **om1-avatar**: A React-based frontend that runs on the BrainPack screen, offering a user interface and real-time avatar display for monitoring and interaction.
...
- [unitree_go2_ros2_sdk](https://github.com/OpenMind/unitree_go2_ros2_sdk.git)
