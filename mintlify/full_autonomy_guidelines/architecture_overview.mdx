...
- **unitree_go2_ros2_sdk**: Provides SLAM (Simultaneous Localization and Mapping), navigation, and sensor integration for the Unitree Go2 robot. It manages sensor data, mapping, video processing and robot movement.
