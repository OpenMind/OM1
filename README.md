- Example: Check out `config/simple_webcam_agent.json5` for a basic webcam-only agent.![OM_Banner_X2 (1)](https://github.com/user-attachments/assets/853153b7-351a-433d-9e1a-d257b781f93c)
